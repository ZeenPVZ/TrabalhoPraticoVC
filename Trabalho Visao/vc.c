...
// CORRIGIDO: loop do kernel dentro do loop dos pixeis
...
// CORRIGIDO: limites do kernel <= offset (era < offset)
...
// Open: erosao seguida de dilatacao
...
// Close: dilatacao seguida de erosao
